package com.lucky.androidlearn.umeng;
...
public class UMengActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_system_info).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String deviceInfo = getDeviceInfo(UMengActivity.this);
                String macInfo = getMac(UMengActivity.this);
                System.out.println("DeviceInfo "+deviceInfo+" macInfo "+macInfo);
                MobclickAgent.reportError(AndroidApplication.getInstances(), "Error: 1001");
