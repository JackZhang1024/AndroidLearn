...
import com.lucky.androidlearn.hybrid.sonic.SonicSessionClientImpl;
...
public class VsonicBrowserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (WebViewSummaryActivity.MODE_DEFAULT != mode) { // sonic mode
            SonicSessionConfig.Builder sessionConfigBuilder = new SonicSessionConfig.Builder();
            sessionConfigBuilder.setSupportLocalServer(true);

            // if it's offline pkg mode, we need to intercept the session connection
            if (WebViewSummaryActivity.MODE_SONIC_WITH_OFFLINE_CACHE == mode) {
                ...
                sessionConfigBuilder.setConnectionInterceptor(new SonicSessionConnectionInterceptor() {
                    ...
                    public SonicSessionConnection getConnection(SonicSession session, Intent intent) {
                        return new OfflinePkgSessionConnection(VsonicBrowserActivity.this, session, intent);
                    }
                });
            }
