...
public class BottomTabLayout extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextNormalColor = getResources().getColor(R.color.bottomTabTextColorNormal);
        mTextSelectedColor = getResources().getColor(R.color.bottomTabTextColorSelected);
    }

    public void setBottomTabTitles(String[] tabTitles){
        this.mTitles = tabTitles;
    }

    public void setBottomTabIcons(int[][] tabIconRes){
        this.mIconRes = tabIconRes;
    }


    public void setViewPager(ViewPager viewPager) {
        if (mTitles == null || mIconRes == null){
            throw  new IllegalStateException("Need set Titles or Icons before setViewPager");
        }
        removeAllViews();
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < getChildCount(); i++) {
                ((TabIconView) mIconLayouts[i].findViewById(R.id.bottom_tab_icon))
                        .transformPage(position == i ? 0 : 1);
                ((TextView) mIconLayouts[i].findViewById(R.id.bottom_tab_text))
